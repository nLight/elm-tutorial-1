...
Elm.Spreadsheet.make = function (_elm) {
   ...
   var toLiteral$ = F2(function (acc,i) {
      toLiteral$: while (true) {
         ...
         if (_p0 === 0) {
               ...
               var name = A2($Basics._op["++"],$String.fromChar($Char.fromCode(65 + modulo)),acc);
               var i$ = (i - modulo) / 26 | 0;
               var _v1 = name,_v2 = i$;
               acc = _v1;
               i = _v2;
   ...
   var header = function (model) {
      var r = A2($Maybe.withDefault,$Array.empty,A2($Array.get,0,model.values));
      return A2($Html.tr,
      _U.list([]),
      A2($List._op["::"],
      A2($Html.td,_U.list([]),_U.list([])),
      $Array.toList(A2($Array.indexedMap,F2(function (i,a) {    return A2($Html.th,_U.list([]),_U.list([$Html.text(toLiteral(i + 1))]));}),r))));
   };
   var getCellVal = F3(function (model,i,j) {
      var getFromArray = $Basics.flip($Array.get);
      var r = A2($Maybe.andThen,i,getFromArray(model.values));
      var cellModel = A2($Maybe.andThen,r,function (row) {    return A2($Maybe.andThen,j,getFromArray(row));});
      return cellModel;
   });
   ...
   var evalMatch = F2(function (model,match) {
      var _p2 = match.submatches;
      if (_p2.ctor === "::" && _p2._0.ctor === "Just" && _p2._1.ctor === "::" && _p2._1._0.ctor === "Just" && _p2._1._1.ctor === "::" && _p2._1._1._0.ctor === "Just" && _p2._1._1._1.ctor === "::" && _p2._1._1._1._0.ctor === "Just" && _p2._1._1._1._1.ctor === "::" && _p2._1._1._1._1._0.ctor === "Just" && _p2._1._1._1._1._1.ctor === "[]")
      {
            var j2$ = $Result.toMaybe($String.toInt(_p2._1._1._1._1._0._0));
            var i2$ = $Result.toMaybe($String.toInt(_p2._1._1._1._0._0));
            var cell2 = A3(getCellVal,model,i2$,j2$);
            var j1$ = $Result.toMaybe($String.toInt(_p2._1._1._0._0));
            var i1$ = $Result.toMaybe($String.toInt(_p2._1._0._0));
            var cell1 = A3(getCellVal,model,i1$,j1$);
            var _p3 = _U.list([cell1,cell2]);
            if (_p3.ctor === "::" && _p3._0.ctor === "Just" && _p3._0._0.ctor === "CellValue" && _p3._1.ctor === "::" && _p3._1._0.ctor === "Just" && _p3._1._0._0.ctor === "CellValue" && _p3._1._1.ctor === "[]")
            {
                  return $Basics.toString(A3(applyOp,_p2._0._0,_p3._0._0._0,_p3._1._0._0._0));
               } else {
                  return "#Error#";
               }
         } else {
   ...
   var evalFormula = F2(function (model,formula) {
      var matches = A3($Regex.find,$Regex.AtMost(5),$Regex.regex("=(sum|mul|div)\\((\\d+):(\\d+)\\,(\\d+):(\\d+)\\)"),formula);
      var _p4 = matches;
      if (_p4.ctor === "::" && _p4._1.ctor === "[]") {
            return A2(evalMatch,model,_p4._0);
         } else {
            return formula;
         }
   });
   var extractValue = F4(function (model,i,j,m) {
      var _p5 = m;
      if (_p5.ctor === "CellValue") {
            return $Basics.toString(_p5._0);
         } else {
            var _p8 = _p5._0;
            var _p6 = A2($Regex.contains,$Regex.regex("^="),_p8);
            if (_p6 === true) {
                  var _p7 = model.focused;
                  var i$ = _p7._0;
                  var j$ = _p7._1;
                  return _U.eq(i,i$) && _U.eq(j,j$) ? _p8 : A2(evalFormula,model,_p8);
               } else {
                  return _p8;
               }
         }
   });
   var Blur = F2(function (a,b) {    return {ctor: "Blur",_0: a,_1: b};});
   var Focus = F2(function (a,b) {    return {ctor: "Focus",_0: a,_1: b};});
   var UpdateCell = F3(function (a,b,c) {    return {ctor: "UpdateCell",_0: a,_1: b,_2: c};});
   var cell = F5(function (model,address,i,j,cellVal) {
      return A2($Html.td,
      _U.list([]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.value(A4(extractValue,model,i,j,cellVal))
              ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p9) {    return A2($Signal.message,address,A3(UpdateCell,i,j,_p9));})
   ...
   var row = F4(function (model,address,i,rowData) {
      ...
      _U.list([]),
      A2($List._op["::"],
      A2($Html.th,_U.list([]),_U.list([$Html.text($Basics.toString(i + 1))])),
      $Array.toList(A2($Array.indexedMap,A3(cell,model,address,i),rowData))));
   });
   var view = F2(function (address,model) {
      return A2($Html.table,
      _U.list([$Html$Attributes.$class("table")]),
      _U.list([A2($Html.tbody,_U.list([]),A2($List.append,_U.list([header(model)]),$Array.toList(A2($Array.indexedMap,A2(row,model,address),model.values))))]));
   });
   var NoOp = {ctor: "NoOp"};
   var Model = F2(function (a,b) {    return {values: a,focused: b};});
   var CellFormula = function (a) {    return {ctor: "CellFormula",_0: a};};
   var CellValue = function (a) {    return {ctor: "CellValue",_0: a};};
   var convertValue = function (val) {
      var _p10 = $String.toFloat(val);
      if (_p10.ctor === "Ok") {
            return CellValue(_p10._0);
         } else {
            return CellFormula(val);
         }
   };
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         case "Focus": return _U.update(model,{focused: {ctor: "_Tuple2",_0: _p11._0,_1: _p11._1}});
         case "Blur": return _U.update(model,{focused: {ctor: "_Tuple2",_0: -1,_1: -1}});
         default: var _p12 = _p11._0;
           var row = A2($Maybe.withDefault,$Array.empty,A2($Array.get,_p12,model.values));
           var val$ = convertValue(_p11._2);
           var row$ = A3($Array.set,_p11._1,val$,row);
           var values = A3($Array.set,_p12,row$,model.values);
           return _U.update(model,{values: values});}
   });
   var model = {values: $Array.fromList(_U.list([$Array.fromList(A2($List.repeat,50,CellValue(1))),$Array.fromList(A2($List.repeat,50,CellValue(2)))]))
